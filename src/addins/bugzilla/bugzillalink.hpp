...
class BugzillaLink
  : public mnote::DynamicNoteTag
{
public:
  typedef Glib::RefPtr<BugzillaLink> Ptr;
  static mnote::DynamicNoteTag::Ptr create()
    {
      return mnote::DynamicNoteTag::Ptr(new BugzillaLink);
    }
  BugzillaLink();
...
protected:
  ...
  virtual bool on_activate(const mnote::NoteEditor & , const Gtk::TextIter &, 
                           const Gtk::TextIter &);
