...
namespace notebooks {
  ...
  {
    NoteManager & noteManager = Mnote::obj().default_note_manager();
  ...
  Note::Ptr Notebook::create_notebook_note()
  {
    ...
    NoteManager & note_manager = Mnote::obj().default_note_manager();
  ...
  {
    return Mnote::obj().default_note_manager().get_or_create_template_note();
  }
